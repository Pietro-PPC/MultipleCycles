corMatC2 <- listenv::listenv()

gvMatC2 <- matrix(nrow=10, ncol=1)
corMatC2$m <- matrix(nrow=7, ncol=1)
varMatC2 <- matrix(nrow=9, ncol=1)

corMatC2$m[1] = cor(bv(newCycleSelections), ebv(newCycleSelections))
...
corMatC2$m[2] = cor(bv(popList[["F2"]]), ebv(popList[["F2"]]))
...
setEbvRf(popList, EBV, "F3", corMatC2, 3)
...
setEbvRf(popList, EBV, "F4", corMatC2, 4)
...
##set EBV using BLUP model##
setEbvRf(popList, EBV, "F5", corMatC2, 5)
...
##set EBV using BLUP model##
setEbvRf(popList, EBV, "PYT", corMatC2, 6)
...
##set EBV using BLUP model##
setEbvRf(popList, EBV, "AYT", corMatC2, 7)
